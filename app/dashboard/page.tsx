      ...
      {user.plan === "starter" && (
        <div className="mb-6 rounded-2xl border border-amber-500/30 bg-amber-500/10 p-4">
          <p className="text-sm text-amber-100">
            ...
            {starterRemaining > 0 ? ` ${starterRemaining} remaining.` : " Limit reached. Upgrade to continue."}
          </p>
          <div className="mt-3 flex gap-3">
            <Link href="/api/subscribe?plan=pro" className="rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold hover:bg-indigo-500">
              Upgrade to Pro
            </Link>
            <Link href="/api/subscribe?plan=agency" className="rounded-xl border border-white/10 px-4 py-2 text-sm hover:bg-white/5">
              Go Agency
            </Link>
          </div>
        </div>
