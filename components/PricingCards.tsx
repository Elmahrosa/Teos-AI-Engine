  ...
  return (
    <section id="pricing" className="mx-auto max-w-6xl scroll-mt-16 px-6 py-16">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-indigo-500 bg-indigo-500/5 p-6 shadow-lg shadow-indigo-500/10 flex flex-col">
          ...
          <p className="mt-4 text-4xl font-bold">
            $29 <span className="text-lg font-normal text-zinc-400">USDC</span>
          </p>
          ...
          <Link
            href="/login?plan=pro"
            className="mt-8 block rounded-xl bg-indigo-600 py-2.5 text-center text-sm font-semibold hover:bg-indigo-500 transition-colors"
          >
            Upgrade to Pro →
          </Link>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 flex flex-col">
          ...
          <p className="mt-4 text-4xl font-bold">
            $99 <span className="text-lg font-normal text-zinc-400">USDC</span>
          </p>
      ...
      <div className="mt-8 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 p-4 text-center text-sm text-zinc-400">
        Pi Network users get <span className="font-medium text-indigo-300">50% off</span> — first 300 users only.
        Pay with USDC on Solana or Pi Network.{' '}
        <a href="#pay" className="text-indigo-400 hover:underline">See payment addresses →</a>
      </div>
    </section>
  );
}
