          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="bg-zinc-900 border border-white/10 rounded-2xl p-6 relative group">
              <div className="flex gap-2 mb-4">
                <button onClick={shareToX} className="p-2 bg-black rounded-lg border border-white/10 hover:bg-zinc-800 transition" title="Post to X">
          ...
          <div className="space-y-4">
            <div className="bg-indigo-600 rounded-2xl p-6 text-white shadow-lg">
              ...
              <p className="text-xs mt-4 opacity-90 leading-tight">
                Optimized for reach on {platform.toUpperCase()}. Best time: <strong>{result.insights.bestTime}</strong>.
              </p>
            </div>

            <div className="bg-zinc-900 border border-white/10 rounded-2xl p-5 shadow-sm">
              <h4 className="text-[10px] font-black uppercase tracking-widest text-zinc-500 mb-4">Compliance Checklist</h4>
